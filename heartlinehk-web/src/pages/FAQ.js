        ...
        <div className="faq">
            ...
            <div className="q-and-a-container">
                ...
                <div className="right-column">
                    <div className="question" style={{backgroundColor: "#f6f2ef"}}>
                    ...
                    <div className="question" style={{backgroundColor: "#fffbf4"}}>
                    ...
                    <div className="question" style={{backgroundColor: "#eaf1f1"}}>
